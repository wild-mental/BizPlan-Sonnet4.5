      ...
      <section className="relative py-4 overflow-hidden w-full">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* 데모 체험 범위 */}
            <div className="relative z-20 max-w-xl mx-auto mb-6 p-4 rounded-2xl bg-slate-900/80 backdrop-blur-sm border border-emerald-500/20">
              <div className="text-base font-semibold text-white mb-2">🎁 무료 데모 체험 범위</div>
              <div className="flex flex-wrap justify-center gap-2 mb-3">
                <span className="px-3 py-1.5 rounded-lg bg-white/10 text-emerald-400 font-medium text-sm">✓ 6대 영역 점수</span>
                <span className="px-3 py-1.5 rounded-lg bg-white/10 text-emerald-400 font-medium text-sm">✓ 합격 예상 확률</span>
                <span className="px-3 py-1.5 rounded-lg bg-white/10 text-emerald-400 font-medium text-sm">✓ 핵심 피드백 3개</span>
              </div>
